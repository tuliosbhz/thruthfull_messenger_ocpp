...
class ChargePointController(cp):
    '''
    Classe que irá receber mensagens do charge point processa-las com os seguinte critério: 
    - Quando for processamento local corre os algoritmos necessários e retorna para os CPs
    - Quando necessitar de interação com o Agregador externo replica as mensagens para o CSMS e responde
    '''
    '''
    TODO: Implementar um caso de uso basico de trocas de mensagem para validar a funcionalidade do Controlador local
    Casos de uso contemplados segundo OCPPv201:
    - 
    - 
    - 
    '''
...
class ClusterManagement():
    id = "P001"
    members_id = [] #Ids of the charge points included on the charging point
    csms_ids = [] 
    ...
    async def on_charge_point_connect(self, websocket, path):
        ...
        proxy_server = ChargePointController(charge_point_id, websocket)
